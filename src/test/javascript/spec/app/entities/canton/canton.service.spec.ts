...
describe('Service Tests', () => {
  describe('Canton Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(CantonService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Canton(0, 'AAAAAAA', false, currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Canton', () => {
        ...
        service.create(new Canton()).subscribe(resp => (expectedResult = resp.body));
